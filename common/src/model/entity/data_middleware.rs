...
#[sea_orm(schema_name = "base", table_name = "data_middleware")]
pub struct Model {
    #[sea_orm(primary_key)]
    pub id: i32,
    #[sea_orm(unique)]
...
impl Related<super::module::Entity> for Entity {
    fn to() -> RelationDef {
        super::rel_module_data_middleware::Relation::Module.def()
    }
    fn via() -> Option<RelationDef> {
        Some(
            super::rel_module_data_middleware::Relation::DataMiddleware
                .def()
                .rev(),
        )
    }
