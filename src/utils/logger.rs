...
use crate::utils::storage::{BlobStorage, Offloadable};
...
impl crate::utils::priority::Prioritizable for LogModel {
    fn get_priority(&self) -> crate::utils::priority::Priority {
        match self.level.to_lowercase().as_str() {
            "error" | "fatal" => crate::utils::priority::Priority::High,
            _ => crate::utils::priority::Priority::Low,
        }
    }
}
